...
const genList = (current, pageSize) => {
    ...
    tableListDataSource.push({
        ...
        owner: '曲丽丽',
        desc: '为全面落实习近平总书记给中国“互联网+”大学生创新创业大赛“青年红色筑梦之旅”大学生回信重要精神，深入推进大众创业万众创新，推动高等教育高质量发展，加快培养创新创业人才，决定举办第七届中国国际“互联网+”大学生创新创业大赛。',
        callNo: 62,
    ...
    tableListDataSource.push({
        ...
        owner: '曲丽丽',
        desc: '中国大学生计算机设计大赛（简称“大赛”或4C）启筹于2007年，始创于2008年，已经举办了13届66场赛事。目前，大赛是全国普通高校学科竞赛排行榜榜单的赛事之一。大赛国赛的参赛对象覆盖中国大陆普通高校中所有专业的当年在校本科生（含当年毕业的本科生）。',
        callNo: 50,
        status: (Math.floor(Math.random() * 10) % 4).toString(),
    ...
    tableListDataSource.push({
        ...
        owner: '曲丽丽',
        desc: '“全国大学生物联网设计竞赛”是由教育部高等学校计算机类专业教学指导委员会和物联网工程专业建设研究专家组共同发起，以促进国内物联网相关专业建设和人才培养为目标，以物联网技术为核心，激发物联网相关专业学生的创造、创新、创业活力，推动高校创新创业教育而举办的面向大学生的学科竞赛。',
        callNo: 28,
        status: (Math.floor(Math.random() * 10) % 4).toString(),
